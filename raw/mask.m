...
cd 'C:\HSV_MoG\final codes\DB3\1\1_5'

testrgbFrame='rgbframe2170.png';
testdepthFrame='frame2170.png';
...
subplot(2,3,6), imshow(a_new),title('RGB of foreground extracted')
...
% [countsH valuesH] = hist(h(:), numberOfBins_h);
...
HSV_vector=[valuesH,valuesS,valuesV]
save('HSV.mat','HSV_vector');  
