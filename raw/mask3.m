...
addpath(genpath('C:\Users\AthiraNambiar\Desktop\PHD\codes\final codes'));

%% !!!!!!!!!!!!!!! DATA AQUISITION !!!!!!!!!!!!!!

% Read the image frames   

% cd 'C:\HSV_MoG\2014\HSVhistogram\HSVDatabase\1'
cd  'C:\Users\AthiraNambiar\Desktop\PHD\codes\2014\HSVhistogram\HSVDatabase\17'
...
% Get the histogram of the S channel.        
 [countsS, valuesS] = hist(h(logical(silhouette)), numberOfBins_s);
...
%Get the histogram of the V channel.
 [countsV, valuesV] = hist(h(logical(silhouette)), numberOfBins_v);
